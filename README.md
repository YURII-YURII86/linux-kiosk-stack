...
| Control Center | [`linux-kiosk-control-center`](https://github.com/YURII-YURII86/linux-kiosk-control-center) | Localhost web control surface for runtime health, service topology, real shell preview, widgets, settings, reports, and safe transaction preview. |
...
python3 -m http.server 8767  # open /examples/static-editor/
```
...
| `linux-kiosk-control-center` | `v0.1.0` | Localhost Control Center UI, runtime snapshot, real shell iframe preview, widget list, settings, reports, read-only bundle, safe widget transaction preview, screenshot gate. |
