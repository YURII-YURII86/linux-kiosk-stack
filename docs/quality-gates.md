...
| `local-dashboard-widget-sdk` | `./scripts/repo_quality_gate.sh` | Schema/types freshness, entry points, docs, privacy. |
...
| `guarded-kiosk-deploy` | `./scripts/repo_quality_gate.sh` | Plan/apply/rollback reports, docs, CI hygiene, privacy. |
