...
| --- | --- | ---: | --- | --- |
| Runtime | `linux-kiosk-appliance-runtime` | `v0.1.0` | Fresh clone, CI, safe install refusal, doctor/status/smoke | Runtime layout, systemd unit templates, service topology, safe install, doctor/status. |
