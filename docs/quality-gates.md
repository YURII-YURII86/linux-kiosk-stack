...
| `guarded-local-config-editor` | `./scripts/repo_quality_gate.sh` | Profile enforcement, profile schema hook accept/reject checks, CLI/server boundaries, docs, privacy. |
